...
function FileInput(props) {
    ...
    return (
        <form id="file-upload-form" class="fileInput-body">
            <input id="file-upload" type="file" name="fileUpload" accept="image/*" className='fileInput-fileinput' onChange={onChange}/>

            <label for="file-upload" id="file-drag" className='fileInput-fileinput-label'>
                ...
                <div className='fileInput-fileinput-selectFile'>
                    ...
                    <span id="file-upload-btn" class="fileInput-fileinput-button">Select a file</span>
                </div>
